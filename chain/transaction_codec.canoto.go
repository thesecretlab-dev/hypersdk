...
const (
	canoto__SerializeTx__Base    = 1
	canoto__SerializeTx__Actions = 2
	canoto__SerializeTx__Auth    = 3

	canoto__SerializeTx__Base__tag    = "\x0a" // canoto.Tag(canoto__SerializeTx__Base, canoto.Len)
	canoto__SerializeTx__Actions__tag = "\x12" // canoto.Tag(canoto__SerializeTx__Actions, canoto.Len)
	canoto__SerializeTx__Auth__tag    = "\x1a" // canoto.Tag(canoto__SerializeTx__Auth, canoto.Len)
)
...
func (*SerializeTx) CanotoSpec(types ...reflect.Type) *canoto.Spec {
	types = append(types, reflect.TypeFor[SerializeTx]())
	...
	s := &canoto.Spec{
		...
		Fields: []canoto.FieldType{
			canoto.FieldTypeFromField(
				...
				/*FieldNumber:   */ canoto__SerializeTx__Base,
				/*Name:          */ "Base",
				/*FixedLength:   */ 0,
				/*Repeated:      */ false,
				/*OneOf:         */ "",
			...
			{
				FieldNumber: canoto__SerializeTx__Actions,
				Name:        "Actions",
				Repeated:    true,
				OneOf:       "",
				TypeBytes:   true,
			...
			{
				FieldNumber: canoto__SerializeTx__Auth,
				Name:        "Auth",
				OneOf:       "",
				TypeBytes:   true,
			},
...
func (c *SerializeTx) UnmarshalCanotoFrom(r canoto.Reader) error {
	...
	*c = SerializeTx{}
	...
	for canoto.HasNext(&r) {
		...
		switch field {
		case canoto__SerializeTx__Base:
			...
			r.B = remainingBytes
		case canoto__SerializeTx__Actions:
			if wireType != canoto.Len {
				return canoto.ErrUnexpectedWireType
			}
		...
		case canoto__SerializeTx__Auth:
			if wireType != canoto.Len {
				return canoto.ErrUnexpectedWireType
			}
