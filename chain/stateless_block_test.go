...
func TestParseHardcodedBlock(t *testing.T) {
	...
	// Regenerated for canoto v0.18 (avalanchego v1.14.2); the migration from the
	// v0.15 vector is attested by TestWireFormatMigrationCanotoV015ToV018.
	hardcodedBlockBytes, err := hex.DecodeString(hardcodedBlockHexCanotoV018)
	r.NoError(err)
