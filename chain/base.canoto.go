...
const (
	canoto__Base__Timestamp = 1
	canoto__Base__ChainID   = 2
	canoto__Base__MaxFee    = 3

	canoto__Base__Timestamp__tag = "\x08" // canoto.Tag(canoto__Base__Timestamp, canoto.Varint)
	canoto__Base__ChainID__tag   = "\x12" // canoto.Tag(canoto__Base__ChainID, canoto.Len)
	canoto__Base__MaxFee__tag    = "\x19" // canoto.Tag(canoto__Base__MaxFee, canoto.I64)
)
...
func (*Base) CanotoSpec(...reflect.Type) *canoto.Spec {
	...
	s := &canoto.Spec{
		...
		Fields: []canoto.FieldType{
			{
				FieldNumber: canoto__Base__Timestamp,
				Name:        "Timestamp",
				OneOf:       "",
				TypeInt:     canoto.SizeOf(zero.Timestamp),
			},
			{
				FieldNumber:    canoto__Base__ChainID,
				Name:           "ChainID",
				OneOf:          "",
			...
			canoto.FieldTypeFromFint(
				...
				/*FieldNumber:   */ canoto__Base__MaxFee,
				/*Name:          */ "MaxFee",
				/*FixedLength:   */ 0,
				/*Repeated:      */ false,
				/*OneOf:         */ "",
